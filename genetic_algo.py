...
if __name__ == '__main__':
    ...
    exact_plot = np.array([100.0] * 100)
    plt.subplot(1,2,1)
    plt.plot(exact_plot, label = "wartosc dokladna", color = 'r')
    plt.plot(gaRUSS.history_fitness/exact_value * 100, label = "RUSS", color = 'b')
    plt.plot(gaRUDH.history_fitness/exact_value * 100, label = "RUDH", color = 'g')
    plt.plot(gaRKSS.history_fitness/exact_value * 100, label = "RKSS", color = 'y')
    plt.plot(gaRKDH.history_fitness/exact_value * 100, label = "RKDH", color = 'c')
    plt.xlabel('Generacja')
    plt.ylabel('Najlepsze przystosowanie w stosunku do wartosci dokladnej [%]')
    ...
    plt.subplot(1,2,2)
    plt.plot(exact_plot, label = "wartosc dokladna", color = 'r')
    plt.plot(gaRUSS.history_bit_comp, label = "RUSS", color = 'b')
    plt.plot(gaRUDH.history_bit_comp, label = "RUDH", color = 'g')
    plt.plot(gaRKSS.history_bit_comp, label = "RKSS", color = 'y')
    plt.plot(gaRKDH.history_bit_comp, label = "RKDH", color = 'c')
    plt.xlabel('Generacja')
    plt.ylabel('Zgodnosc bitowa z dokladnym rozwiazaniem [%]')
    plt.title('Zgodnosc bitowa w trakcie pokolen')
    plt.legend()
    plt.grid()
